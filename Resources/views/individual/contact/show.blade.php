...
@section('breadcrumbs', Breadcrumbs::render(Route::getCurrentRoute()->getName(), $contact))

@section('actions')
    {!! \Html::backButton('core.settings.contacts.index') !!}
    {!! \Html::modelDropdown('core.settings.contacts', $contact->id, ['color' => 'success',
        'actions' => array_merge(['edit'], ($contact->deleted_at == null) ? ['delete'] : ['restore'])]) !!}
@endsection
...
@section('content')
                            ...
                            <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <p class="fw-bolder">{{ \Modules\Core\Supports\Constant::ENABLED_OPTIONS[$contact->enabled] }}</p>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
    ...
    {!! \Modules\Core\Supports\CHTML::confirmModal('Contact', ['delete', 'restore']) !!}
@endsection
