<div class="card-body">
    <div class="row">
        <div class="@if(isset($relation->name)) col-md-6 @else col-md-12 @endif">
            {!! \Form::nText('name', 'Name', old('name', $relation->name ?? null), true) !!}
        </div>
        @if(isset($relation->name))
            <div class="col-md-6">
                {!! \Form::nSelect('enabled', 'Enabled', \Modules\Core\Supports\Constant::ENABLED_OPTIONS,
                    old('enabled', ($relation->enabled ?? \Modules\Core\Supports\Constant::ENABLED_OPTION)), true) !!}
            </div>
        @endif
    </div>
    <div class="row">
        <div class="col-12">
            {!! \Form::nTextarea('remarks', 'Remarks', old('remarks', $relation->remarks ?? null), false) !!}
        </div>
    </div>
    <div class="row mt-3">
