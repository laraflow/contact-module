...
@section('content')
                            ...
                            <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <p class="fw-bolder">{{ \Modules\Core\Supports\Constant::ENABLED_OPTIONS[$occupation->enabled] }}</p>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
    ...
    {!! \Modules\Core\Supports\CHTML::confirmModal('Occupations', ['delete', 'restore']) !!}
@endsection
