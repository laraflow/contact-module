...
@section('actions')
    {!! \Html::linkButton('Add Occupations', 'contact.settings.occupations.create', [], 'mdi mdi-plus', 'success') !!}
...
@section('content')
                ...
                <div class="card card-default">
                    @if(!empty($occupations))
                                ...
                                <table class="table table-hover mb-0" id="permission-table">
                                    ...
                                    @forelse($occupations as $index => $occupation)
                                        <tr @if($occupation->deleted_at != null) class="table-danger" @endif>
                                            ...
                                            <td class="text-center">{{ $occupation->created_at->format(config('app.datetime')) ?? '' }}</td>
                        ...
                        <div class="card-footer bg-transparent pb-0">
                            {!! \Modules\Core\Supports\CHTML::pagination($occupations) !!}
                        </div>
                    @else
    ...
    <!-- /.container-fluid -->
    {!! \Modules\Core\Supports\CHTML::confirmModal('Occupations', ['export', 'delete', 'restore']) !!}
@endsection
