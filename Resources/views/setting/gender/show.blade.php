...
@section('actions')
    ...
    {!! \Html::modelDropdown('contact.settings.genders', $gender->id, ['color' => 'success',
        'actions' => array_merge(['edit'], ($gender->deleted_at == null) ? ['delete'] : ['restore'])]) !!}
@endsection
...
@section('content')
                            ...
                            <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <p class="fw-bolder">{{ $gender->name ?? null }}</p>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="d-block">Enabled</label>
                                        <p class="fw-bolder">{{ \Modules\Core\Supports\Constant::ENABLED_OPTIONS[$gender->enabled] }}</p>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
                                        <label class="d-block">Remarks</label>
                                        <p class="fw-bolder">{{ $gender->remarks ?? null }}</p>
                                    </div>
                                </div>
                            </div>
    ...
    {!! \Modules\Core\Supports\CHTML::confirmModal('Gender', ['delete', 'restore']) !!}
@endsection
