...
@section('actions')
    ...
    @can('core.settings.roles.permission')
    ...
    {!! \Html::modelDropdown('core.settings.roles', $role->id, ['color' => 'success',
...
@section('content')
        ...
        <div class="modal fade" id="bd-example-modal-lg" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    {!! \Form::open(['route' => ['core.settings.roles.permission', $role->id], 'method' => 'put', 'id' => 'role-permission-form']) !!}
    ...
    @endcan
    {!! \Modules\Core\Supports\CHTML::confirmModal('Role', ['delete', 'restore']) !!}
@endsection
