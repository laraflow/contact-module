<div class="card-body">
    <div class="row">
        ...
        <div class="col-md-4">
            {!! \Form::nSelect('guard_name', 'Guard', config('core.guard'), old('guard_name', $role->guard_name ?? \Modules\Core\Supports\Constant::PERMISSION_GUARD)) !!}
        </div>
        <div class="col-md-4">
            {!! \Form::nSelect('enabled', 'Enabled', \Modules\Core\Supports\Constant::ENABLED_OPTIONS,
                old('enabled', ($role->enabled ?? \Modules\Core\Supports\Constant::ENABLED_OPTION))) !!}
        </div>
    </div>
    <div class="row">
        <div class="col-12">
