...
use Modules\Contact\Http\Requests\Setting\OccupationRequest;
use Modules\Contact\Services\Setting\OccupationService;
...
class OccupationController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('contact::setting.occupation.index', [
    ...
    {
        return view('contact::setting.occupation.create');
    }
    ...
    public function show($id)
    {
        if ($occupation = $this->occupationService->getOccupationById($id)) {
            return view('contact::setting.occupation.show', [
    ...
    {
        if ($occupation = $this->occupationService->getOccupationById($id)) {
            return view('contact::setting.occupation.edit', [
                'occupation' => $occupation
            ]);
        }
    ...
    {
        return view('contact::setting.occupation.import');
    }
