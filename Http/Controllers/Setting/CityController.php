...
use Modules\Contact\Http\Requests\Setting\CityRequest;
use Modules\Contact\Services\Setting\CityService;
...
class CityController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('contact::setting.city.index', [
            'citys' => $citys
        ]);
    }
    ...
    {
        return view('contact::setting.city.create');
    }
    ...
    public function show($id)
    {
        if ($city = $this->cityService->getCityById($id)) {
            return view('contact::setting.city.show', [
                'city' => $city,
    ...
    {
        if ($city = $this->cityService->getCityById($id)) {
            return view('contact::setting.city.edit', [
                'city' => $city
            ]);
        }
    ...
    {
        return view('contact::setting.city.import');
    }
