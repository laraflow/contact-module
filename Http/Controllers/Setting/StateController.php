...
use Modules\Contact\Http\Requests\Setting\StateRequest;
use Modules\Contact\Services\Setting\StateService;
...
class StateController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('contact::setting.state.index', [
            'states' => $states
        ]);
    }
    ...
    {
        return view('contact::setting.state.create');
    }
    ...
    public function show($id)
    {
        if ($state = $this->stateService->getStateById($id)) {
            return view('contact::setting.state.show', [
                'state' => $state,
    ...
    {
        if ($state = $this->stateService->getStateById($id)) {
            return view('contact::setting.state.edit', [
                'state' => $state
            ]);
        }
    ...
    {
        return view('contact::setting.state.import');
    }
