...
namespace Modules\Contact\Services\Individual;
...
use Modules\Contact\Repositories\Eloquent\Individual\ContactRepository;
use Throwable;

/**
 * @class ContactService
 * @package Modules\Contact\Services\Individual
 */
